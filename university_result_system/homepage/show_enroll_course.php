...
<h2 style="margin-top: 7%; margin-bottom:1%; text-align:center">For Drop the Enrolled Course</h2>
       ...
       while ($data = mysqli_fetch_assoc($result)){
        ...
        ?>
            ...
            <tr>
                ...
                <td> <a href="dropcourse.php?student_id=<?php echo $student_id ?>">Drop</a></td>
